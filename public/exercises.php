...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['edit_exercise'])) {
        ...
        $sql = "UPDATE exercises 
                SET session_id = :session_id, exercise_name = :exercise_name, weight = :weight, 
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <form method="POST" style="display:inline;">
                            ...
                            <input type="text" name="exercise_name" placeholder="Nom" value="<?= htmlspecialchars($exercise['exercise_name'] ?? '') ?>">
